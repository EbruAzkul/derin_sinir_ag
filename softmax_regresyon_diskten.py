...
transform = transforms.Compose([
    transforms.ToTensor(),  # Görüntüleri tensöre dönüştür ve normalize et
])
...
def train_ch3(net, train_iter, test_iter, loss, num_epochs, updater):
    ...
    plt.savefig("training_plot.png")  # **Grafiği kaydet**
    plt.show()
...
def predict_ch3(net, test_iter, n=6):
    ...
    plt.savefig("predictions.png")  # **Tahmin görsellerini kaydet**
    plt.show()
